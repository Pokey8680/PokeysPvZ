.class Lorg/codegist/crest/config/annotate/MatrixParamAnnotationHandler;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "<",
        "Lorg/codegist/crest/annotate/MatrixParam;",
        ">;"
    }
.end annotation
...
.method public bridge synthetic handleInterfaceAnnotation(Ljava/lang/annotation/Annotation;Lorg/codegist/crest/config/InterfaceConfigBuilder;)V
    ...
    .prologue
    .line 34
    check-cast p1, Lorg/codegist/crest/annotate/MatrixParam;

    .end local p1    # "x0":Ljava/lang/annotation/Annotation;
    invoke-virtual {p0, p1, p2}, Lorg/codegist/crest/config/annotate/MatrixParamAnnotationHandler;->handleInterfaceAnnotation(Lorg/codegist/crest/annotate/MatrixParam;Lorg/codegist/crest/config/InterfaceConfigBuilder;)V

    return-void
.end method

.method public handleInterfaceAnnotation(Lorg/codegist/crest/annotate/MatrixParam;Lorg/codegist/crest/config/InterfaceConfigBuilder;)V
    .locals 2
    .param p1, "annotation"    # Lorg/codegist/crest/annotate/MatrixParam;
    ...
    sget-object v1, Lorg/codegist/crest/config/ParamType;->MATRIX:Lorg/codegist/crest/config/ParamType;
    ...
    invoke-interface {p1}, Lorg/codegist/crest/annotate/MatrixParam;->value()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v1}, Lorg/codegist/crest/config/annotate/MatrixParamAnnotationHandler;->ph(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {p1}, Lorg/codegist/crest/annotate/MatrixParam;->defaultValue()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lorg/codegist/crest/config/annotate/MatrixParamAnnotationHandler;->nullIfUnset(Ljava/lang/String;)Ljava/lang/String;
...
.method public bridge synthetic handleMethodAnnotation(Ljava/lang/annotation/Annotation;Lorg/codegist/crest/config/MethodConfigBuilder;)V
    ...
    .end local p1    # "x0":Ljava/lang/annotation/Annotation;
    invoke-virtual {p0, p1, p2}, Lorg/codegist/crest/config/annotate/MatrixParamAnnotationHandler;->handleMethodAnnotation(Lorg/codegist/crest/annotate/MatrixParam;Lorg/codegist/crest/config/MethodConfigBuilder;)V

    return-void
.end method

.method public handleMethodAnnotation(Lorg/codegist/crest/annotate/MatrixParam;Lorg/codegist/crest/config/MethodConfigBuilder;)V
    .locals 2
    .param p1, "annotation"    # Lorg/codegist/crest/annotate/MatrixParam;
...
.method public bridge synthetic handleParameterAnnotation(Ljava/lang/annotation/Annotation;Lorg/codegist/crest/config/ParamConfigBuilder;)V
    ...
    .end local p1    # "x0":Ljava/lang/annotation/Annotation;
    invoke-virtual {p0, p1, p2}, Lorg/codegist/crest/config/annotate/MatrixParamAnnotationHandler;->handleParameterAnnotation(Lorg/codegist/crest/annotate/MatrixParam;Lorg/codegist/crest/config/ParamConfigBuilder;)V

    return-void
.end method

.method public handleParameterAnnotation(Lorg/codegist/crest/annotate/MatrixParam;Lorg/codegist/crest/config/ParamConfigBuilder;)V
    .locals 2
    .param p1, "annotation"    # Lorg/codegist/crest/annotate/MatrixParam;
