.class Lorg/codegist/crest/config/annotate/jaxrs/PathParamAnnotationHandler;
...
.method public bridge synthetic handleParameterAnnotation(Ljava/lang/annotation/Annotation;Lorg/codegist/crest/config/ParamConfigBuilder;)V
    ...
    .prologue
    .line 34
    check-cast p1, Ljavax/ws/rs/PathParam;

    .end local p1    # "x0":Ljava/lang/annotation/Annotation;
    invoke-virtual {p0, p1, p2}, Lorg/codegist/crest/config/annotate/jaxrs/PathParamAnnotationHandler;->handleParameterAnnotation(Ljavax/ws/rs/PathParam;Lorg/codegist/crest/config/ParamConfigBuilder;)V

    return-void
.end method

.method public handleParameterAnnotation(Ljavax/ws/rs/PathParam;Lorg/codegist/crest/config/ParamConfigBuilder;)V
    .locals 2
    .param p1, "annotation"    # Ljavax/ws/rs/PathParam;
    ...
    invoke-interface {p1}, Ljavax/ws/rs/PathParam;->value()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v1}, Lorg/codegist/crest/config/annotate/jaxrs/PathParamAnnotationHandler;->ph(Ljava/lang/String;)Ljava/lang/String;
