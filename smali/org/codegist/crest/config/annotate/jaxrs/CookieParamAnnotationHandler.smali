.class Lorg/codegist/crest/config/annotate/jaxrs/CookieParamAnnotationHandler;
...
.method public bridge synthetic handleParameterAnnotation(Ljava/lang/annotation/Annotation;Lorg/codegist/crest/config/ParamConfigBuilder;)V
    ...
    .prologue
    .line 34
    check-cast p1, Ljavax/ws/rs/CookieParam;

    .end local p1    # "x0":Ljava/lang/annotation/Annotation;
    invoke-virtual {p0, p1, p2}, Lorg/codegist/crest/config/annotate/jaxrs/CookieParamAnnotationHandler;->handleParameterAnnotation(Ljavax/ws/rs/CookieParam;Lorg/codegist/crest/config/ParamConfigBuilder;)V

    return-void
.end method

.method public handleParameterAnnotation(Ljavax/ws/rs/CookieParam;Lorg/codegist/crest/config/ParamConfigBuilder;)V
    .locals 2
    .param p1, "annotation"    # Ljavax/ws/rs/CookieParam;
    ...
    invoke-interface {p1}, Ljavax/ws/rs/CookieParam;->value()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v1}, Lorg/codegist/crest/config/annotate/jaxrs/CookieParamAnnotationHandler;->ph(Ljava/lang/String;)Ljava/lang/String;
