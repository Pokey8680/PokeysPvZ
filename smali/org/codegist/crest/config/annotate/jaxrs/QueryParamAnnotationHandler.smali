.class Lorg/codegist/crest/config/annotate/jaxrs/QueryParamAnnotationHandler;
...
.method public bridge synthetic handleParameterAnnotation(Ljava/lang/annotation/Annotation;Lorg/codegist/crest/config/ParamConfigBuilder;)V
    ...
    .prologue
    .line 34
    check-cast p1, Ljavax/ws/rs/QueryParam;

    .end local p1    # "x0":Ljava/lang/annotation/Annotation;
    invoke-virtual {p0, p1, p2}, Lorg/codegist/crest/config/annotate/jaxrs/QueryParamAnnotationHandler;->handleParameterAnnotation(Ljavax/ws/rs/QueryParam;Lorg/codegist/crest/config/ParamConfigBuilder;)V

    return-void
.end method

.method public handleParameterAnnotation(Ljavax/ws/rs/QueryParam;Lorg/codegist/crest/config/ParamConfigBuilder;)V
    .locals 2
    .param p1, "annotation"    # Ljavax/ws/rs/QueryParam;
    ...
    invoke-interface {p1}, Ljavax/ws/rs/QueryParam;->value()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v1}, Lorg/codegist/crest/config/annotate/jaxrs/QueryParamAnnotationHandler;->ph(Ljava/lang/String;)Ljava/lang/String;
