.class Lorg/codegist/crest/config/annotate/DELETEAnnotationHandler;
.super Lorg/codegist/crest/config/annotate/NoOpAnnotationHandler;
.source "DELETEAnnotationHandler.java"
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "<",
        "Lorg/codegist/crest/annotate/DELETE;",
        ">;"
    }
.end annotation
...
.method public bridge synthetic handleInterfaceAnnotation(Ljava/lang/annotation/Annotation;Lorg/codegist/crest/config/InterfaceConfigBuilder;)V
    ...
    .prologue
    .line 31
    check-cast p1, Lorg/codegist/crest/annotate/DELETE;

    .end local p1    # "x0":Ljava/lang/annotation/Annotation;
    invoke-virtual {p0, p1, p2}, Lorg/codegist/crest/config/annotate/DELETEAnnotationHandler;->handleInterfaceAnnotation(Lorg/codegist/crest/annotate/DELETE;Lorg/codegist/crest/config/InterfaceConfigBuilder;)V

    return-void
.end method

.method public handleInterfaceAnnotation(Lorg/codegist/crest/annotate/DELETE;Lorg/codegist/crest/config/InterfaceConfigBuilder;)V
    .locals 1
    .param p1, "annotation"    # Lorg/codegist/crest/annotate/DELETE;
    .param p2, "builder"    # Lorg/codegist/crest/config/InterfaceConfigBuilder;

    .prologue
    .line 35
    sget-object v0, Lorg/codegist/crest/config/MethodType;->DELETE:Lorg/codegist/crest/config/MethodType;
...
.method public bridge synthetic handleMethodAnnotation(Ljava/lang/annotation/Annotation;Lorg/codegist/crest/config/MethodConfigBuilder;)V
    ...
    .end local p1    # "x0":Ljava/lang/annotation/Annotation;
    invoke-virtual {p0, p1, p2}, Lorg/codegist/crest/config/annotate/DELETEAnnotationHandler;->handleMethodAnnotation(Lorg/codegist/crest/annotate/DELETE;Lorg/codegist/crest/config/MethodConfigBuilder;)V

    return-void
.end method

.method public handleMethodAnnotation(Lorg/codegist/crest/annotate/DELETE;Lorg/codegist/crest/config/MethodConfigBuilder;)V
    .locals 1
    .param p1, "annotation"    # Lorg/codegist/crest/annotate/DELETE;
