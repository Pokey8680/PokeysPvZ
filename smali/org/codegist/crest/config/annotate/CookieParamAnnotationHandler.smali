.class Lorg/codegist/crest/config/annotate/CookieParamAnnotationHandler;
.super Lorg/codegist/crest/config/annotate/ParamAnnotationHandler;
.source "CookieParamAnnotationHandler.java"
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "<",
        "Lorg/codegist/crest/annotate/CookieParam;",
        ">;"
    }
.end annotation
...
.method public bridge synthetic handleInterfaceAnnotation(Ljava/lang/annotation/Annotation;Lorg/codegist/crest/config/InterfaceConfigBuilder;)V
    ...
    .prologue
    .line 34
    check-cast p1, Lorg/codegist/crest/annotate/CookieParam;

    .end local p1    # "x0":Ljava/lang/annotation/Annotation;
    invoke-virtual {p0, p1, p2}, Lorg/codegist/crest/config/annotate/CookieParamAnnotationHandler;->handleInterfaceAnnotation(Lorg/codegist/crest/annotate/CookieParam;Lorg/codegist/crest/config/InterfaceConfigBuilder;)V

    return-void
.end method

.method public handleInterfaceAnnotation(Lorg/codegist/crest/annotate/CookieParam;Lorg/codegist/crest/config/InterfaceConfigBuilder;)V
    .locals 2
    .param p1, "annotation"    # Lorg/codegist/crest/annotate/CookieParam;
    ...
    invoke-interface {p1}, Lorg/codegist/crest/annotate/CookieParam;->value()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v1}, Lorg/codegist/crest/config/annotate/CookieParamAnnotationHandler;->ph(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {p1}, Lorg/codegist/crest/annotate/CookieParam;->defaultValue()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lorg/codegist/crest/config/annotate/CookieParamAnnotationHandler;->nullIfUnset(Ljava/lang/String;)Ljava/lang/String;
...
.method public bridge synthetic handleMethodAnnotation(Ljava/lang/annotation/Annotation;Lorg/codegist/crest/config/MethodConfigBuilder;)V
    ...
    .end local p1    # "x0":Ljava/lang/annotation/Annotation;
    invoke-virtual {p0, p1, p2}, Lorg/codegist/crest/config/annotate/CookieParamAnnotationHandler;->handleMethodAnnotation(Lorg/codegist/crest/annotate/CookieParam;Lorg/codegist/crest/config/MethodConfigBuilder;)V

    return-void
.end method

.method public handleMethodAnnotation(Lorg/codegist/crest/annotate/CookieParam;Lorg/codegist/crest/config/MethodConfigBuilder;)V
    .locals 2
    .param p1, "annotation"    # Lorg/codegist/crest/annotate/CookieParam;
...
.method public bridge synthetic handleParameterAnnotation(Ljava/lang/annotation/Annotation;Lorg/codegist/crest/config/ParamConfigBuilder;)V
    ...
    .end local p1    # "x0":Ljava/lang/annotation/Annotation;
    invoke-virtual {p0, p1, p2}, Lorg/codegist/crest/config/annotate/CookieParamAnnotationHandler;->handleParameterAnnotation(Lorg/codegist/crest/annotate/CookieParam;Lorg/codegist/crest/config/ParamConfigBuilder;)V

    return-void
.end method

.method public handleParameterAnnotation(Lorg/codegist/crest/annotate/CookieParam;Lorg/codegist/crest/config/ParamConfigBuilder;)V
    .locals 2
    .param p1, "annotation"    # Lorg/codegist/crest/annotate/CookieParam;
