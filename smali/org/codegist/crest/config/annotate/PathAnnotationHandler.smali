.class Lorg/codegist/crest/config/annotate/PathAnnotationHandler;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "<",
        "Lorg/codegist/crest/annotate/Path;",
        ">;"
    }
.end annotation
...
.method public bridge synthetic handleInterfaceAnnotation(Ljava/lang/annotation/Annotation;Lorg/codegist/crest/config/InterfaceConfigBuilder;)V
    ...
    .prologue
    .line 31
    check-cast p1, Lorg/codegist/crest/annotate/Path;

    .end local p1    # "x0":Ljava/lang/annotation/Annotation;
    invoke-virtual {p0, p1, p2}, Lorg/codegist/crest/config/annotate/PathAnnotationHandler;->handleInterfaceAnnotation(Lorg/codegist/crest/annotate/Path;Lorg/codegist/crest/config/InterfaceConfigBuilder;)V

    return-void
.end method

.method public handleInterfaceAnnotation(Lorg/codegist/crest/annotate/Path;Lorg/codegist/crest/config/InterfaceConfigBuilder;)V
    .locals 1
    .param p1, "annotation"    # Lorg/codegist/crest/annotate/Path;
    .param p2, "builder"    # Lorg/codegist/crest/config/InterfaceConfigBuilder;

    .prologue
    .line 39
    invoke-interface {p1}, Lorg/codegist/crest/annotate/Path;->value()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lorg/codegist/crest/config/annotate/PathAnnotationHandler;->ph(Ljava/lang/String;)Ljava/lang/String;
...
.method public bridge synthetic handleMethodAnnotation(Ljava/lang/annotation/Annotation;Lorg/codegist/crest/config/MethodConfigBuilder;)V
    ...
    .end local p1    # "x0":Ljava/lang/annotation/Annotation;
    invoke-virtual {p0, p1, p2}, Lorg/codegist/crest/config/annotate/PathAnnotationHandler;->handleMethodAnnotation(Lorg/codegist/crest/annotate/Path;Lorg/codegist/crest/config/MethodConfigBuilder;)V

    return-void
.end method

.method public handleMethodAnnotation(Lorg/codegist/crest/annotate/Path;Lorg/codegist/crest/config/MethodConfigBuilder;)V
    .locals 1
    .param p1, "annotation"    # Lorg/codegist/crest/annotate/Path;
