...
.method static invokeAnyImpl(Lorg/roboguice/shaded/goole/common/util/concurrent/ListeningExecutorService;Ljava/util/Collection;ZJ)Ljava/lang/Object;
    .locals 23
    .param p0, "executorService"    # Lorg/roboguice/shaded/goole/common/util/concurrent/ListeningExecutorService;
    .param p2, "timed"    # Z
    .param p3, "nanos"    # J
    ...
    :goto_0
    invoke-static/range {v19 .. v19}, Lorg/roboguice/shaded/goole/common/base/Preconditions;->checkArgument(Z)V

    .line 612
    invoke-static {v13}, Lorg/roboguice/shaded/goole/common/collect/Lists;->newArrayListWithCapacity(I)Ljava/util/ArrayList;
    ...
    invoke-static {v0, v1, v9}, Lorg/roboguice/shaded/goole/common/util/concurrent/MoreExecutors;->submitAndAddQueueListener(Lorg/roboguice/shaded/goole/common/util/concurrent/ListeningExecutorService;Ljava/util/concurrent/Callable;Ljava/util/concurrent/BlockingQueue;)Lorg/roboguice/shaded/goole/common/util/concurrent/ListenableFuture;
...
.method public static platformThreadFactory()Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-static {v1}, Lorg/roboguice/shaded/goole/common/base/Throwables;->propagate(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
...
.method static renamingDecorator(Ljava/util/concurrent/Executor;Lorg/roboguice/shaded/goole/common/base/Supplier;)Ljava/util/concurrent/Executor;
    ...
    .prologue
    .line 774
    .local p1, "nameSupplier":Lorg/roboguice/shaded/goole/common/base/Supplier;, "Lorg/roboguice/shaded/goole/common/base/Supplier<Ljava/lang/String;>;"
    invoke-static {p0}, Lorg/roboguice/shaded/goole/common/base/Preconditions;->checkNotNull(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static submitAndAddQueueListener(Lorg/roboguice/shaded/goole/common/util/concurrent/ListeningExecutorService;Ljava/util/concurrent/Callable;Ljava/util/concurrent/BlockingQueue;)Lorg/roboguice/shaded/goole/common/util/concurrent/ListenableFuture;
    ...
    .line 683
    .local v0, "future":Lorg/roboguice/shaded/goole/common/util/concurrent/ListenableFuture;, "Lorg/roboguice/shaded/goole/common/util/concurrent/ListenableFuture<TT;>;"
    new-instance v1, Lorg/roboguice/shaded/goole/common/util/concurrent/MoreExecutors$1;

    invoke-direct {v1, p2, v0}, Lorg/roboguice/shaded/goole/common/util/concurrent/MoreExecutors$1;-><init>(Ljava/util/concurrent/BlockingQueue;Lorg/roboguice/shaded/goole/common/util/concurrent/ListenableFuture;)V
    ...
    invoke-interface {v0, v1, v2}, Lorg/roboguice/shaded/goole/common/util/concurrent/ListenableFuture;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
