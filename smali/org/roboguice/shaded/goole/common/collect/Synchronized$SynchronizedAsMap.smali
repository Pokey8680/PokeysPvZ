...
.method constructor <init>(Ljava/util/Map;Ljava/lang/Object;)V
    ...
    .prologue
    .line 1162
    .local p0, "this":Lorg/roboguice/shaded/goole/common/collect/Synchronized$SynchronizedAsMap;, "Lorg/roboguice/shaded/goole/common/collect/Synchronized$SynchronizedAsMap<TK;TV;>;"
...
.method public entrySet()Ljava/util/Set;
    ...
    .line 1175
    :try_start_0
    iget-object v0, p0, Lorg/roboguice/shaded/goole/common/collect/Synchronized$SynchronizedAsMap;->asMapEntrySet:Ljava/util/Set;

    if-nez v0, :cond_0

    .line 1176
    new-instance v0, Lorg/roboguice/shaded/goole/common/collect/Synchronized$SynchronizedAsMapEntries;
    ...
    invoke-direct {v0, v2, v3}, Lorg/roboguice/shaded/goole/common/collect/Synchronized$SynchronizedAsMapEntries;-><init>(Ljava/util/Set;Ljava/lang/Object;)V

    iput-object v0, p0, Lorg/roboguice/shaded/goole/common/collect/Synchronized$SynchronizedAsMap;->asMapEntrySet:Ljava/util/Set;
...
.method public get(Ljava/lang/Object;)Ljava/util/Collection;
    ...
    .line 1166
    .local p0, "this":Lorg/roboguice/shaded/goole/common/collect/Synchronized$SynchronizedAsMap;, "Lorg/roboguice/shaded/goole/common/collect/Synchronized$SynchronizedAsMap<TK;TV;>;"
    iget-object v2, p0, Lorg/roboguice/shaded/goole/common/collect/Synchronized$SynchronizedAsMap;->mutex:Ljava/lang/Object;
...
.method public values()Ljava/util/Collection;
    ...
    .line 1185
    :try_start_0
    iget-object v0, p0, Lorg/roboguice/shaded/goole/common/collect/Synchronized$SynchronizedAsMap;->asMapValues:Ljava/util/Collection;

    if-nez v0, :cond_0

    .line 1186
    new-instance v0, Lorg/roboguice/shaded/goole/common/collect/Synchronized$SynchronizedAsMapValues;
    ...
    invoke-direct {v0, v2, v3}, Lorg/roboguice/shaded/goole/common/collect/Synchronized$SynchronizedAsMapValues;-><init>(Ljava/util/Collection;Ljava/lang/Object;)V

    iput-object v0, p0, Lorg/roboguice/shaded/goole/common/collect/Synchronized$SynchronizedAsMap;->asMapValues:Ljava/util/Collection;
