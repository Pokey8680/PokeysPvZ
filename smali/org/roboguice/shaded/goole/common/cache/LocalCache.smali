...
.method copyEntry(Lorg/roboguice/shaded/goole/common/cache/LocalCache$ReferenceEntry;Lorg/roboguice/shaded/goole/common/cache/LocalCache$ReferenceEntry;)Lorg/roboguice/shaded/goole/common/cache/LocalCache$ReferenceEntry;
    ...
    invoke-virtual {v1, p1, p2}, Lorg/roboguice/shaded/goole/common/cache/LocalCache$Segment;->copyEntry(Lorg/roboguice/shaded/goole/common/cache/LocalCache$ReferenceEntry;Lorg/roboguice/shaded/goole/common/cache/LocalCache$ReferenceEntry;)Lorg/roboguice/shaded/goole/common/cache/LocalCache$ReferenceEntry;
...
.method getAll(Ljava/lang/Iterable;)Lorg/roboguice/shaded/goole/common/collect/ImmutableMap;
    ...
    .line 3985
    :try_start_1
    iget-object v9, p0, Lorg/roboguice/shaded/goole/common/cache/LocalCache;->defaultLoader:Lorg/roboguice/shaded/goole/common/cache/CacheLoader;

    invoke-virtual {p0, v4, v9}, Lorg/roboguice/shaded/goole/common/cache/LocalCache;->loadAll(Ljava/util/Set;Lorg/roboguice/shaded/goole/common/cache/CacheLoader;)Ljava/util/Map;
    ...
    .line 3989
    new-instance v9, Lorg/roboguice/shaded/goole/common/cache/CacheLoader$InvalidCacheLoadException;
    ...
    invoke-direct {v9, v10}, Lorg/roboguice/shaded/goole/common/cache/CacheLoader$InvalidCacheLoadException;-><init>(Ljava/lang/String;)V
    ...
    .line 3995
    .local v0, "e":Lorg/roboguice/shaded/goole/common/cache/CacheLoader$UnsupportedLoadingOperationException;
    :try_start_2
    invoke-interface {v4}, Ljava/util/Set;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual {p0, v3, v9}, Lorg/roboguice/shaded/goole/common/cache/LocalCache;->get(Ljava/lang/Object;Lorg/roboguice/shaded/goole/common/cache/CacheLoader;)Ljava/lang/Object;
    ...
    .line 4003
    .end local v0    # "e":Lorg/roboguice/shaded/goole/common/cache/CacheLoader$UnsupportedLoadingOperationException;
    .end local v3    # "key":Ljava/lang/Object;, "TK;"
    :catchall_0
    move-exception v9

    iget-object v10, p0, Lorg/roboguice/shaded/goole/common/cache/LocalCache;->globalStatsCounter:Lorg/roboguice/shaded/goole/common/cache/AbstractCache$StatsCounter;

    invoke-interface {v10, v1}, Lorg/roboguice/shaded/goole/common/cache/AbstractCache$StatsCounter;->recordHits(I)V

    .line 4004
    iget-object v10, p0, Lorg/roboguice/shaded/goole/common/cache/LocalCache;->globalStatsCounter:Lorg/roboguice/shaded/goole/common/cache/AbstractCache$StatsCounter;

    invoke-interface {v10, v5}, Lorg/roboguice/shaded/goole/common/cache/AbstractCache$StatsCounter;->recordMisses(I)V
    ...
    invoke-interface {v7, v3, v8}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_3
    .catch Lorg/roboguice/shaded/goole/common/cache/CacheLoader$UnsupportedLoadingOperationException; {:try_start_3 .. :try_end_3} :catch_0
    ...
    :cond_4
    :try_start_4
    invoke-static {v7}, Lorg/roboguice/shaded/goole/common/collect/ImmutableMap;->copyOf(Ljava/util/Map;)Lorg/roboguice/shaded/goole/common/collect/ImmutableMap;
    :try_end_4
...
.method getAllPresent(Ljava/lang/Iterable;)Lorg/roboguice/shaded/goole/common/collect/ImmutableMap;
    ...
    :cond_1
    iget-object v7, p0, Lorg/roboguice/shaded/goole/common/cache/LocalCache;->globalStatsCounter:Lorg/roboguice/shaded/goole/common/cache/AbstractCache$StatsCounter;

    invoke-interface {v7, v1}, Lorg/roboguice/shaded/goole/common/cache/AbstractCache$StatsCounter;->recordHits(I)V

    .line 3959
    iget-object v7, p0, Lorg/roboguice/shaded/goole/common/cache/LocalCache;->globalStatsCounter:Lorg/roboguice/shaded/goole/common/cache/AbstractCache$StatsCounter;

    invoke-interface {v7, v4}, Lorg/roboguice/shaded/goole/common/cache/AbstractCache$StatsCounter;->recordMisses(I)V

    .line 3960
    invoke-static {v5}, Lorg/roboguice/shaded/goole/common/collect/ImmutableMap;->copyOf(Ljava/util/Map;)Lorg/roboguice/shaded/goole/common/collect/ImmutableMap;
...
.method invalidateAll(Ljava/lang/Iterable;)V
    ...
    invoke-virtual {p0, v1}, Lorg/roboguice/shaded/goole/common/cache/LocalCache;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method loadAll(Ljava/util/Set;Lorg/roboguice/shaded/goole/common/cache/CacheLoader;)Ljava/util/Map;
    ...
    .local p2, "loader":Lorg/roboguice/shaded/goole/common/cache/CacheLoader;, "Lorg/roboguice/shaded/goole/common/cache/CacheLoader<-TK;TV;>;"
    invoke-static/range {p2 .. p2}, Lorg/roboguice/shaded/goole/common/base/Preconditions;->checkNotNull(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 4019
    .local v9, "stopwatch":Lorg/roboguice/shaded/goole/common/base/Stopwatch;
    const/4 v10, 0x0
    ...
    invoke-virtual {v0, v1}, Lorg/roboguice/shaded/goole/common/cache/CacheLoader;->loadAll(Ljava/lang/Iterable;)Ljava/util/Map;
    :try_end_0
    .catch Lorg/roboguice/shaded/goole/common/cache/CacheLoader$UnsupportedLoadingOperationException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v12, v0, Lorg/roboguice/shaded/goole/common/cache/LocalCache;->globalStatsCounter:Lorg/roboguice/shaded/goole/common/cache/AbstractCache$StatsCounter;

    sget-object v13, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v9, v13}, Lorg/roboguice/shaded/goole/common/base/Stopwatch;->elapsed(Ljava/util/concurrent/TimeUnit;)J

    move-result-wide v14

    invoke-interface {v12, v14, v15}, Lorg/roboguice/shaded/goole/common/cache/AbstractCache$StatsCounter;->recordLoadException(J)V
    ...
    .line 4045
    new-instance v12, Lorg/roboguice/shaded/goole/common/cache/CacheLoader$InvalidCacheLoadException;
    ...
    invoke-direct {v12, v13}, Lorg/roboguice/shaded/goole/common/cache/CacheLoader$InvalidCacheLoadException;-><init>(Ljava/lang/String;)V
    ...
    .line 4026
    .local v2, "e":Lorg/roboguice/shaded/goole/common/cache/CacheLoader$UnsupportedLoadingOperationException;
    const/4 v10, 0x1
    ...
    .line 4038
    .end local v2    # "e":Lorg/roboguice/shaded/goole/common/cache/CacheLoader$UnsupportedLoadingOperationException;
    :catchall_0
    move-exception v12
    ...
    iget-object v13, v0, Lorg/roboguice/shaded/goole/common/cache/LocalCache;->globalStatsCounter:Lorg/roboguice/shaded/goole/common/cache/AbstractCache$StatsCounter;

    sget-object v14, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v9, v14}, Lorg/roboguice/shaded/goole/common/base/Stopwatch;->elapsed(Ljava/util/concurrent/TimeUnit;)J

    move-result-wide v14

    invoke-interface {v13, v14, v15}, Lorg/roboguice/shaded/goole/common/cache/AbstractCache$StatsCounter;->recordLoadException(J)V
    ...
    new-instance v12, Lorg/roboguice/shaded/goole/common/util/concurrent/UncheckedExecutionException;

    invoke-direct {v12, v2}, Lorg/roboguice/shaded/goole/common/util/concurrent/UncheckedExecutionException;-><init>(Ljava/lang/Throwable;)V
    ...
    new-instance v12, Lorg/roboguice/shaded/goole/common/util/concurrent/ExecutionError;

    invoke-direct {v12, v2}, Lorg/roboguice/shaded/goole/common/util/concurrent/ExecutionError;-><init>(Ljava/lang/Error;)V
    ...
    :cond_2
    invoke-virtual {v9}, Lorg/roboguice/shaded/goole/common/base/Stopwatch;->stop()Lorg/roboguice/shaded/goole/common/base/Stopwatch;
    ...
    invoke-virtual {v0, v5, v11}, Lorg/roboguice/shaded/goole/common/cache/LocalCache;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v12, v14, v15}, Lorg/roboguice/shaded/goole/common/cache/AbstractCache$StatsCounter;->recordLoadSuccess(J)V
...
.method newValueReference(Lorg/roboguice/shaded/goole/common/cache/LocalCache$ReferenceEntry;Ljava/lang/Object;I)Lorg/roboguice/shaded/goole/common/cache/LocalCache$ValueReference;
    ...
    invoke-virtual {v1, v2, p1, v3, p3}, Lorg/roboguice/shaded/goole/common/cache/LocalCache$Strength;->referenceValue(Lorg/roboguice/shaded/goole/common/cache/LocalCache$Segment;Lorg/roboguice/shaded/goole/common/cache/LocalCache$ReferenceEntry;Ljava/lang/Object;I)Lorg/roboguice/shaded/goole/common/cache/LocalCache$ValueReference;
